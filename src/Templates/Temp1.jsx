    ...
    <>
      {cvGenerated ? (
        <>
          ...
          >
            <div
              className="col-sm-4 t1-1-side temp1-p"
              style={{
                backgroundColor: "#EDE9EA",
                borderBottomRightRadius: "4rem",
              }}
            >
              ...
              <div style={{ padding: "30px" }}>
                <h5 style={{ color: "#538CB9" }}>Profile</h5>
                <p>{profile}</p>

                <h6 style={{ color: "#538CB9",fontWeight:"700",fontSize:"19px" }}>Contact Information</h6>
                <p>
                  <strong style={{ color: "#538CB9",fontSize:"14px" }}>Phone:</strong> {phone}
                </p>
                <p>
                  <strong style={{ color: "#538CB9",fontSize:"14px" }}>Website:</strong>{" "}
                  <Link
                ...
                <p>
                  <strong style={{ color: "#538CB9",fontSize:"14px" }}>Email:</strong>
                  <Link
                    to="https://parentheses.pk/"
                    style={{ textDecoration: "none" }}
                    target="-/"
                ...
                <div className="cv-section">
                  {customLinks.length > 0 ? (
                    ...
                    <p>No custom links added.</p>
                  )}
                </div>

                <h5 style={{ color: "#538CB9" }}>Hobbies</h5>
                <ul>
            ...
            <div
              className="col-sm-8 right-temp1"
            ...
            >
              ...
              >
                <div style={{ paddingRight: "2px" }}>
                  ...
                  <h5 style={{ color: "#538CB9" }}>JOB TITLE</h5>
                  ...
                  <div>
                    <h5 style={{fontSize:"14px",fontWeight:"700" }} >{schoolName1}</h5>
                    <p>{schoolDescription1}</p>
                  </div>
                  <div>
                    <h5 style={{fontSize:"14px",fontWeight:"700" }} >{schoolName2}</h5>
                    <p>{schoolDescription2}</p>
                  </div>
                  {educations.map((education, index) => (
                    <div key={index}>
                      <h5 style={{fontSize:"14px",fontWeight:"700" }} >{education.name}</h5>
                  ...
                  <div>
                    <h5 style={{fontSize:"14px",fontWeight:"700" }} >{companyName1}</h5>
                    <p>{companyDescription1}</p>
                  </div>
                  <div>
                    <h5 style={{fontSize:"14px",fontWeight:"700" }} >{companyName2}</h5>
                    <p>{companyDescription2}</p>
                  </div>
                  {customWorkExperience.map((work, index) => (
                    <div key={index}>
                      <h5 style={{fontSize:"14px",fontWeight:"700" }} >{work.companyName}</h5>
          ...
          <button onClick={downloadCV} style={{border:"none",height:"3rem", marginLeft:"40.5%",marginBottom:"5rem",borderRadius:"10px",width:"15rem",backgroundColor:"#6E6E6E",color:"white",fontWeight:"700",fontSize:"20px"}}>Download CV In PDF</button>
        </>
      ) : (
        <div>
          {" "}
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              type="text"
                              placeholder="Institute & Degree Description"
